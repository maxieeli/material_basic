...
> {
  ...
  dragStartMousePosition = null as any
  dragNode: NodeInstance<TreeDataType>
  currentMouseOverDroppableNodeKey = null as any
  ...
  onNodeDrop = (event: React.DragEvent<HTMLDivElement>, node: any, outsideTree: boolean = false) => {
