...
import type { ComponentClass, HTMLAttributes, Key, ComponentType } from 'react'
...
export interface CSSMotionListProps extends
  Omit<CSSMotionProps, 'onVisibleChanged'>,
  Omit<HTMLAttributes<any>, 'children'> {
...
): ComponentClass<CSSMotionListProps> {
