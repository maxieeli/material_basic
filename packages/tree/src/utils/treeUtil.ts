 ...
 */
export function convertTreeToData(rootNodes: ReactNode): DataNode[] {
  function dig(node: ReactNode): DataNode[] {
...
export function traverseDataNodes(
  ...
  function processNode(
    ...
    const children: any[] = node ? node[mergeChildrenPropName] : dataNodes
