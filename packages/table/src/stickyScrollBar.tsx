...
function addEventListener(target: any, eventType: any, cb: any, option: any) {
...
function getOffset(node: any) {
  ...
  return {
    ...
    top: box.left + (window.pageYOffset || docElem.scrollTop) - (docElem.clientTop || document.body.clientTop || 0),
  }
}
