import type {
  CSSProperties, ForwardRefExoticComponent,
  Ref, ReactNode, ReactElement,
} from 'react'
import {
  useRef, forwardRef,
...
export function genCSSMotion(
...
): ForwardRefExoticComponent<CSSMotionProps & { ref?: Ref<any> }> {
  ...
  const CSSMotion = forwardRef<any, CSSMotionProps>((props, ref) => {
    const {
      // Default config
      visible = true,
      removeOnLeave = true,
