...
var Tree = /*#__PURE__*/function (_React$Component) {
  ...
  function Tree() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onNodeDragEnter", function (event, node) {
      ...
      var _calcDropPosition = calcDropPosition(event, dragNode, node, indent, _this.dragStartMousePosition, allowDrop, flattenNodes, keyEntities, expandedKeys),
    ...
    _defineProperty(_assertThisInitialized(_this), "onNodeDragOver", function (event, node) {
      ...
      var _calcDropPosition2 = calcDropPosition(event, dragNode, node, indent, _this.dragStartMousePosition, allowDrop, flattenNodes, keyEntities, expandedKeys),
    ...
    _defineProperty(_assertThisInitialized(_this), "onNodeCheck", function (e, treeNode, checked) {
      ...
      if (checkStrictly) {
        ...
        checkedObj = _checkedKeys; // [Legacy] This is used for `tree-select`
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_jsx(TreeContext.Provider, {
        ...
        children: /*#__PURE__*/_jsx("div", {
          ...
          style: rootStyle,
          children: /*#__PURE__*/_jsx(NodeList, _objectSpread(_objectSpread({
            ref: this.listRef,
            prefixCls: prefixCls,
            style: style,
            data: flattenNodes,
